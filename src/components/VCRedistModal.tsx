...
export function VCRedistModal({ show, onClose }: VCRedistModalProps) {
  ...
  return (
    ...
    >
      <div
        className="mxu-overlay-surface w-full max-w-md mx-4 bg-bg-secondary rounded-xl shadow-2xl border border-border overflow-hidden animate-in zoom-in-95 duration-200"
